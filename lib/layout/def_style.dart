...
class DefStyle {
  ...
  static TextStyle textLiHead = const TextStyle(
      fontSize: 16, fontWeight: FontWeight.w500, letterSpacing: 0.15);
  static TextStyle textLibody =
      const TextStyle(fontSize: 15, letterSpacing: 0.15);

  static ButtonStyle grayBtnStyle = ElevatedButton.styleFrom(
      backgroundColor: const Color.fromRGBO(128, 128, 128, 1),
      fixedSize: const Size.fromWidth(120),
      padding: const EdgeInsets.only(top: 10, bottom: 10));
  static ButtonStyle blueBtnStyle = ElevatedButton.styleFrom(
  ...
  static Widget deopBox(List<String> dropItems) {
    return Padding(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            const SizedBox(width: 100, child: Text("제조사")),
