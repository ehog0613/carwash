...
class _JoinWidget extends State<JoinWidget> {
  ...
  final List<Widget> _userType = <Widget>[
    const Text("서비스이용자"),
    const Text("세차요원")
  ];
                  ...
                  children: [
                    ...
                    Column(children: [
                      ...
                      TextFormField(
                        ...
                        validator: (value) =>
                            CwValidators.userPswdConf(value, _pswdControl.text),
                      ),
                      const SizedBox(
                        height: 10,
                      ),
  ...
  void _joinSubmit() async {
    if (_joinFormKey.currentState!.validate()) {
      ...
      CwDialogs.modalLoading(context, "서버 통신중 입니다. 잠시만 기다려 주세요.");
