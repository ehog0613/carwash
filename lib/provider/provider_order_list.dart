      ...
      body: RefreshIndicator(
        ...
        child: SafeArea(
            child: Container(
              ...
              Text("접수 목록이 없습니다.",style:Theme.of(context).textTheme.labelMedium,),
            )
  ...
  Widget _listViewSep(){
    return ListView.separated(itemBuilder: (BuildContext context,index){
      return GestureDetector(
        ...
        child:Container(
          decoration: BoxDecoration(borderRadius: const BorderRadius.all(Radius.circular(10)),color: DefStyle.statusColor(_orderList.orders[index].status)),
